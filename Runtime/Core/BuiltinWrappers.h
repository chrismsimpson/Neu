...
template<Unsigned IntType>
inline constexpr int countTrailingZeroes(IntType value) {
...
// bits in the IntType.
template<Unsigned IntType>
inline constexpr int countTrailingZeroesSafe(IntType value) {
...
template<Unsigned IntType>
inline constexpr int countLeadingZeroes(IntType value) {
...
template<Unsigned IntType>
inline constexpr int countLeadingZeroesSafe(IntType value) {
...
inline constexpr int bitScanForward(IntType value) {
    ...
    return 1 + countTrailingZeroes(static_cast<MakeUnsigned<IntType>>(value));
